...
if (!in_array(filter_input(INPUT_GET, 'id'), $product_ids)){
    ...
    else{$_SESSION['shopping_cart']['0'] = array(
            'id' => filter_input(INPUT_GET, 'id'),
            'name' => filter_input(INPUT_POST, 'name'),
            'price' => filter_input(INPUT_POST, 'price'),
            'quantity'  => filter_input(INPUT_POST, 'quantity'),
...
if (isset($_GET["subcategory"])) {
    $query = 'SELECT * FROM products WHERE subcategory="' . $_GET["subcategory"] . '"ORDER by id ASC';
}
else{
...
?>
   <div class="row justify-content-center">
       <form method="post" action="Products.php?action=add&id=<?php
       if (isset($_GET["subcategory"])) {
           echo $product['id'] . "&subcategory=" . $_GET["subcategory"];
       }
       else{
           echo $product['id'];
       }
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            ?>
            <tr>
                <td class="alignment" colspan="3">Total</td>
                <td class="alignment">$ <?php echo number_format($total, 2); ?></td>
                <td></td>
            </tr>
            <tr>
            <td colspan="5">
